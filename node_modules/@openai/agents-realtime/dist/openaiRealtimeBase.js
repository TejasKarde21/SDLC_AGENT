 ...
 */
exports.DEFAULT_OPENAI_REALTIME_MODEL = 'gpt-realtime-2.1';
/**
...
class OpenAIRealtimeBase extends utils_3.EventEmitterDelegate {
    ...
    _onMessage(event) {
        const result = (0, openaiRealtimeEvents_1.parseRealtimeEvent)(event);
        if (result.data === null) {
            return;
        }
        ...
        if (parsed.type === 'response.done') {
            ...
            if (!response.success) {
                (0, internal_1.logModelActionError)(logger_1.default, 'Error parsing response done event', response.error);
                return;
            }
        ...
        if (parsed.type === 'conversation.item.added' ||
            ...
            if (parsed.item.type === 'mcp_list_tools' &&
                ...
                try {
                    ...
                    (0, internal_1.logToolActionError)(logger_1.default, 'Error emitting mcp_tools_listed', err, parsed.item);
                }
    ...
    sendFunctionCallOutput(toolCall, output, startResponse = true) {
        ...
        try {
            ...
            (0, internal_1.logToolActionError)(logger_1.default, 'Error parsing tool call item', error, toolCall);
        }
        if (startResponse) {
            this.requestResponse();
        }
