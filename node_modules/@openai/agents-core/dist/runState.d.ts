...
declare const pendingSessionHistoryTransactionSchema: z.ZodObject<{
    ...
    transactionKind: z.ZodEnum<{
        ...
        accepted_replace: "accepted_replace";
    }>;
    runItemIndexes: z.ZodArray<z.ZodNumber>;
    replaceRunItemIndexes: z.ZodArray<z.ZodNumber>;
    alreadyPersistedCount: z.ZodNumber;
    persistedItemCount: z.ZodNumber;
    deferredItemIndexes: z.ZodArray<z.ZodNumber>;
}, z.core.$strict>;
type PendingSessionHistoryTransaction = z.infer<typeof pendingSessionHistoryTransactionSchema>;
...
export declare const SerializedRunState: z.ZodObject<{
    ...
    originalInput: z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodUnion<readonly [z.ZodObject<{
        ...
        caller: z.ZodOptional<z.ZodDiscriminatedUnion<[z.ZodObject<{
        ...
        providerData: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
        id: z.ZodOptional<z.ZodString>;
        type: z.ZodLiteral<"program_output">;
        callId: z.ZodString;
        output: z.ZodString;
        status: z.ZodEnum<{
            completed: "completed";
    ...
    context: z.ZodObject<{
        ...
        functionApprovals: z.ZodOptional<z.ZodArray<z.ZodObject<{
        ...
        legacyFunctionApprovals: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodObject<{
            approved: z.ZodUnion<[z.ZodArray<z.ZodString>, z.ZodBoolean]>;
            rejected: z.ZodUnion<[z.ZodArray<z.ZodString>, z.ZodBoolean]>;
            messages: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
            stickyRejectMessage: z.ZodOptional<z.ZodString>;
    ...
    generatedItems: z.ZodArray<z.ZodDiscriminatedUnion<[z.ZodObject<{
        ...
        executionStatus: z.ZodOptional<z.ZodLiteral<"executed">>;
    }, z.core.$strip>, z.ZodObject<{
        ...
        type: z.ZodLiteral<"compaction_item">;
        rawItem: z.ZodObject<{
            providerData: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
            type: z.ZodLiteral<"compaction">;
            encrypted_content: z.ZodString;
        ...
        functionToolStateKey: z.ZodOptional<z.ZodString>;
    }, z.core.$strip>], "type">>;
    pendingAgentToolRuns: z.ZodDefault<z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>>;
    pendingAgentToolRunAliases: z.ZodDefault<z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>>;
    ...
    currentTurnDeferredSessionItemIndexes: z.ZodOptional<z.ZodArray<z.ZodNumber>>;
    currentTurnBlockedSessionStartIndex: z.ZodOptional<z.ZodNumber>;
    currentTurnExecutedWithSessionBinding: z.ZodOptional<z.ZodLiteral<true>>;
    currentTurnSessionInputItems: z.ZodOptional<z.ZodArray<z.ZodUnion<readonly [z.ZodObject<{
        providerData: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
        id: z.ZodOptional<z.ZodString>;
        type: z.ZodOptional<z.ZodLiteral<"message">>;
        role: z.ZodLiteral<"user">;
    ...
    pendingSessionHistoryTransaction: z.ZodOptional<z.ZodObject<{
        operationId: z.ZodString;
        transactionKind: z.ZodEnum<{
            blocked_append: "blocked_append";
            accepted_replace: "accepted_replace";
    ...
    pendingLegacyCompactionSessionItems: z.ZodOptional<z.ZodArray<z.ZodUnion<readonly [z.ZodObject<{
        providerData: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
        id: z.ZodOptional<z.ZodString>;
        type: z.ZodOptional<z.ZodLiteral<"message">>;
        role: z.ZodLiteral<"user">;
...
export declare class RunState<TContext, TAgent extends Agent<any, any>> {
     ...
     */
    _currentTurnSessionReasoningItemIdPolicy: ReasoningItemIdPolicy | undefined;
    /**
     * Normalized session input frozen before the current transaction-aware model request.
     */
    _currentTurnSessionHistoryTransactionInputItems: AgentInputItem[] | undefined;
    /**
     ...
     */
    _serializedCurrentStep: NextStep | undefined;
    /**
     ...
     */
    _pendingSessionHistoryTransaction: PendingSessionHistoryTransaction | undefined;
    /**
     ...
     */
    _pendingLegacyCompactionSessionItems: AgentInputItem[] | undefined;
    /**
    ...
    getToolSearchRuntimeToolsForOutput(agent: Agent<any, any>, toolSearchOutput: protocol.ToolSearchOutputItem): Tool<TContext>[];
    ...
    setPendingAgentToolRun(toolName: string, callId: string, serializedState: string, aliases?: readonly string[]): void;
