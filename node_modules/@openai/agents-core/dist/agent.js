...
const agentOutputTypeWarning_1 = require("./agentOutputTypeWarning.js");
        ...
        if (config.handoffOutputTypeWarningEnabled === undefined ||
            ...
            if (this.handoffs && this.outputType) {
                ...
                if (logger_1.default.dontLogModelData) {
                    if ((0, agentOutputTypeWarning_1.hasDefinitelyDifferentOutputTypes)(outputTypes)) {
                        logger_1.default.warn('[Agent] Warning: Handoff agents have different output types. Output type details are redacted. You can make it type-safe by using Agent.create({ ... }) method instead.');
                    }
                }
                else {
                    const serializedOutputTypes = outputTypes.map((type) => JSON.stringify(type));
                    if (new Set(serializedOutputTypes).size > 1) {
                        logger_1.default.warn(`[Agent] Warning: Handoff agents have different output types: ${serializedOutputTypes.join(', ')}. You can make it type-safe by using Agent.create({ ... }) method instead.`);
                    }
                }
            }
        }
    ...
    asTool(options) {
        ...
        const baseTool = (0, tool_1.tool)({
            ...
            execute: async (params, context, details) => {
                ...
                (0, usageTracking_1.setRunnerParentUsageRecorder)(runner, (0, usageTracking_1.getToolUsageRecorder)(details));
                (0, invocationContext_1.setRunnerInvocationSpanParent)(runner, (0, agentToolRunConfig_1.getToolCallParentSpanFromDetails)(details));
