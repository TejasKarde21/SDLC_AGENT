...
class StreamedRunResult extends RunResultBase {
    ...
    constructor(result = {}) {
        ...
        const { signal: combinedSignal, cleanup: cleanupCombinedSignal } = (0, abortSignals_1.combineAbortSignalsWithOptions)([result.signal, this.#abortController.signal], {
            onAbortSignalAnyError: (error) => {
                (0, logger_1.logModelAndToolActionDebug)(logger_1.default, 'AbortSignal.any failed, falling back:', error);
            },
        });
    ...
    _raiseError(err) {
        ...
        this.#completedPromise.catch((e) => {
            (0, logger_1.logModelAndToolActionDebug)(logger_1.default, 'Resulted in an error:', e);
        });
        this.#detachAbortHandler();
    }
    /**
    ...
    #handleAbort() {
        ...
        if (controller) {
            try {
                ...
                (0, logger_1.logModelAndToolActionDebug)(logger_1.default, 'Failed to close readable stream on abort:', err);
            }
        }
        this.#detachAbortHandler();
    }
    #detachAbortHandler() {
        ...
        if (this.#combinedSignal && this.#abortHandler) {
            try {
                ...
                (0, logger_1.logModelAndToolActionDebug)(logger_1.default, 'Failed to remove abort listener:', err);
            }
        }
        try {
            ...
            (0, logger_1.logModelAndToolActionDebug)(logger_1.default, 'Failed to clean up combined abort listeners:', err);
        }
        this.#combinedSignalCleanup = () => { };
