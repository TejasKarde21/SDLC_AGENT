...
exports.PromptCacheBreakpoint = zod_1.z.object({
    /**
     * The breakpoint mode. Always `explicit`.
     */
    mode: zod_1.z.literal('explicit'),
});
exports.InputText = exports.SharedBase.extend({
     ...
     */
    promptCacheBreakpoint: exports.PromptCacheBreakpoint.optional(),
});
...
exports.AssistantMessageItem = MessageBase.extend({
     ...
     */
    phase: zod_1.z.enum(['commentary', 'final_answer']).optional(),
    /**
...
// Tool call types
// ----------------------------
exports.ToolCaller = zod_1.z.discriminatedUnion('type', [
    zod_1.z.object({ type: zod_1.z.literal('direct') }),
    zod_1.z.object({
        type: zod_1.z.literal('program'),
        callerId: zod_1.z.string(),
    }),
]);
exports.ProgramCallItem = exports.ItemBase.extend({
    type: zod_1.z.literal('program'),
    callId: zod_1.z.string(),
    code: zod_1.z.string(),
    fingerprint: zod_1.z.string(),
});
exports.ProgramCallResultItem = exports.ItemBase.extend({
    type: zod_1.z.literal('program_output'),
    callId: zod_1.z.string(),
    output: zod_1.z.string(),
    status: zod_1.z.enum(['completed', 'incomplete']),
});
exports.HostedToolCallItem = exports.ItemBase.extend({
     ...
     */
    caller: exports.ToolCaller.optional(),
});
