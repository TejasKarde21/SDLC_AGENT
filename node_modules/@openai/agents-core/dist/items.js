...
exports.RunToolApprovalItem = exports.RunHandoffOutputItem = exports.RunHandoffCallItem = exports.RunCompactionItem = exports.RunReasoningItem = exports.RunToolCallOutputItem = exports.RunToolSearchOutputItem = exports.RunToolSearchCallItem = exports.RunToolCallItem = exports.RunMessageOutputItem = exports.RunItemBase = void 0;
 ...
 */
class RunCompactionItem extends RunItemBase {
    rawItem;
    agent;
...
exports.RunCompactionItem = RunCompactionItem;
...
function getDefaultApprovalFunctionToolStateKey(rawItem) {
    ...
    return (0, toolIdentity_1.getFunctionToolStateKeyForCall)(rawItem);
}
function getDefaultApprovalToolName(rawItem) {
    ...
    return (0, toolIdentity_1.getToolCallQualifiedName)(rawItem) ?? rawItem.name;
}
