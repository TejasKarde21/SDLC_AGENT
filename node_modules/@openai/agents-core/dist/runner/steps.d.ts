...
export declare class SingleStepResult {
    ...
    nextStep: NextStep;
    finalOutputSource?: FinalOutputSource | undefined;
    constructor(originalInput: string | AgentInputItem[], modelResponse: ModelResponse, preStepItems: RunItem[], newStepItems: RunItem[], nextStep: NextStep, finalOutputSource?: FinalOutputSource | undefined);
