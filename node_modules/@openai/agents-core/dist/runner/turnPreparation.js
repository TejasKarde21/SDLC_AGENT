...
async function runInputGuardrailsForTurn(state, runnerGuardrails, isResumingFromInterruption, handlers = {}) {
    ...
    if (guardrails.parallel.length > 0) {
        ...
        const parallelGuardrailPromise = (0, guardrails_1.runInputGuardrails)(state, guardrails.parallel, { onErrorObserved: handlers.onParallelError }).catch(() => []);
