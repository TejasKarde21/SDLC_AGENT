...
export declare class CompactionItemValidationError extends UserError {
}
export declare function toAgentInputList(originalInput: string | AgentInputItem[]): AgentInputItem[];
export declare function assertValidCompactionItems(items: readonly AgentInputItem[]): void;
 ...
 */
export declare function deduplicateAgentInputItemsPreferringLatest(items: AgentInputItem[]): AgentInputItem[];
