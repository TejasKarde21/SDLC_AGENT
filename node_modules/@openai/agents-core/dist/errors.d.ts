 ...
 */
export declare class InvalidToolOutputError extends UserError {
    /** The original error thrown during validation, if any. */
    originalError?: unknown;
    /** Context from the tool output that failed validation. */
    toolOutput?: ToolOutputErrorContext;
    constructor(message: string, state?: RunState<any, Agent<any, any>>, originalError?: unknown, toolOutput?: ToolOutputErrorContext);
}
/**
