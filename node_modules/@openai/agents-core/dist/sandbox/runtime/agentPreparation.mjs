...
export function prepareSandboxAgent({ agent, session, capabilities, runConfigModel, processManifest = true, tracingParent, }) {
    ...
    const prepared = agent.clone({
        ...
        instructions: async (runContext, preparedAgent) => {
            ...
            const remoteMountPolicy = renderRemoteMountPolicyInstructions(runtimeManifest, canEditorAccessPath);
