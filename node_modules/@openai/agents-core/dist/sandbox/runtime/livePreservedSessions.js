...
exports.forgetLivePreservedOwnedSessionHandle = forgetLivePreservedOwnedSessionHandle;
exports.rejectLivePreservedOwnedSessionHandle = rejectLivePreservedOwnedSessionHandle;
...
function forgetLivePreservedOwnedSessionHandle(args) {
    if (!args.state) {
        return;
    }
...
function rejectLivePreservedOwnedSessionHandle(args) {
    if (!args.state) {
        return;
    }
    const liveSessions = livePreservedOwnedSessionsByRunState.get(args.state);
