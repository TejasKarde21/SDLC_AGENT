...
export declare function prepareSandboxAgent<TContext, TOutput extends AgentOutputType>({ agent, session, capabilities, runConfigModel, processManifest, tracingParent, }: PrepareSandboxAgentArgs<TContext, TOutput>): SandboxAgent<TContext, TOutput>;
