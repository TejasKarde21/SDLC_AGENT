    ...
    tools() {
        ...
        const tools = [
            (0, tool_1.tool)({
                ...
                execute: async ({ cmd, workdir, shell, login, tty, yield_time_ms, max_output_tokens, }, _context, details) => await (0, spans_1.withSandboxSpan)('sandbox.exec', {
                    cmd,
                    workdir,
                    shell,
                    login,
        ...
        if (session.supportsPty?.() && session.writeStdin) {
            tools.push((0, tool_1.tool)({
                ...
                execute: async ({ session_id, chars, yield_time_ms, max_output_tokens, }, _context, details) => await (0, spans_1.withSandboxSpan)('sandbox.write_stdin', {
                    session_id,
