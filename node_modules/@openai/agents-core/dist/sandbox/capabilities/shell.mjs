    ...
    tools() {
        ...
        const tools = [
            tool({
                ...
                execute: async ({ cmd, workdir, shell, login, tty, yield_time_ms, max_output_tokens, }, _context, details) => await withSandboxSpan('sandbox.exec', {
                    cmd,
                    workdir,
                    shell,
                    login,
        ...
        if (session.supportsPty?.() && session.writeStdin) {
            tools.push(tool({
                ...
                execute: async ({ session_id, chars, yield_time_ms, max_output_tokens, }, _context, details) => await withSandboxSpan('sandbox.write_stdin', {
                    session_id,
