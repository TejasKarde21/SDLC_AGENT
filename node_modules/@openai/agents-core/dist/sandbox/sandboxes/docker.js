...
class DockerSandboxClient {
    ...
    async canReusePreservedOwnedSession(state, options = {}) {
        ...
        if (state.image !== (resolvedOptions.image ?? DEFAULT_DOCKER_IMAGE) ||
            !dockerExposedPortSetsEqual(state.configuredExposedPorts ?? [], (0, sessionStateValues_1.normalizeExposedPorts)(resolvedOptions.exposedPorts))) {
            return false;
        }
    ...
    async restoreIfNeeded(state, archiveLimits) {
        ...
        if ((0, sessionStateTrust_1.isRunStateSessionState)(state)) {
            ...
            const trustedState = {
                ...
                configuredExposedPorts: (0, sessionStateValues_1.normalizeExposedPorts)(resolvedOptions.exposedPorts),
                dockerVolumeNames: [],
