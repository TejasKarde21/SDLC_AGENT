...
import type { SandboxClient, SandboxClientOptions, SandboxClientCreateArgs, SandboxArchiveLimits, SandboxClientResumeOptions, SandboxConcurrencyLimits, SandboxPreservedSessionReuseOptions, SandboxSessionSerializationOptions } from '../client';
...
export declare class DockerSandboxClient implements SandboxClient<DockerSandboxClientOptions, DockerSandboxSessionState> {
    ...
    resume(state: DockerSandboxSessionState, options?: SandboxClientResumeOptions): Promise<DockerSandboxSession>;
