...
import { BaseMCPServerStdio, BaseMCPServerStreamableHttp, BaseMCPServerSSE, MCPTool } from '../../mcpShared';
import type { CallToolResult, CallToolResultContent, DefaultMCPServerStdioOptions, InitializeResult, MCPCallToolOptions, MCPListResourcesParams, MCPListResourcesResult, MCPListResourceTemplatesResult, MCPReadResourceResult, MCPServerStdioOptions, MCPServerStreamableHttpOptions, MCPServerSSEOptions } from '../../mcp';
...
export declare class NodeMCPServerStdio extends BaseMCPServerStdio {
    ...
    protected _toolsCacheGeneration: number;
