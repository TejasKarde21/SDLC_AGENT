...
async function* convertChatCompletionsStreamToResponses(response, stream, options = {}) {
    ...
    for await (const chunk of stream) {
        ...
        if (delta.content) {
            if (!state.text_content) {
                ...
                state.messageItemId =
                    response.id && response.id !== openaiChatCompletionsModel_1.FAKE_ID ? response.id : undefined;
            }
            yield {
    ...
    if ((0, openaiChatCompletionsContentFilter_1.shouldSynthesizeContentFilterRefusal)({
