...
export declare function setDefaultOpenAIClient(client: OpenAIClient): void;
export declare function getDefaultOpenAIClient<TClient extends OpenAIClient = OpenAIClient>(): TClient | undefined;
