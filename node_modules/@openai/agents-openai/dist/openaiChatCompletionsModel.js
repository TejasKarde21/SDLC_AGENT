...
class OpenAIChatCompletionsModel {
    ...
    async getResponse(request) {
        ...
        const { response, rawResponse } = await (0, agents_core_1.withGenerationSpan)(async (span) => {
