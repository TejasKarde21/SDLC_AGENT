...
class OpenAIResponsesCompactionSession {
    ...
    async restoreUnderlyingSessionItemsAfterFailedClear(previousItems, error) {
        ...
        try {
            ...
            (0, internal_1.logModelAndToolActionWarning)(logger, 'Failed to inspect session history after compaction replacement clear failed.', inspectionError);
            return;
        }
    ...
    async restoreUnderlyingSessionItems(previousItems, error, options = {}) {
        try {
            ...
            (0, internal_1.logModelAndToolActionWarning)(logger, 'Failed to restore session history after compaction replacement failed.', restoreError);
            return;
        }
        (0, internal_1.logModelAndToolActionWarning)(logger, 'Restored previous session history after compaction replacement failed.', error);
    }
