...
export class OpenAIResponsesCompactionSession {
    ...
    async restoreUnderlyingSessionItemsAfterFailedClear(previousItems, error) {
        ...
        try {
            ...
            logModelAndToolActionWarning(logger, 'Failed to inspect session history after compaction replacement clear failed.', inspectionError);
            return;
        }
    ...
    async restoreUnderlyingSessionItems(previousItems, error, options = {}) {
        ...
        logModelAndToolActionWarning(logger, 'Restored previous session history after compaction replacement failed.', error);
    }
